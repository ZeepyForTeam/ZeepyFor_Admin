...
def molit_api_cron_job(): # 부동산 API 사용 함수
    apartment = False
    officetels = True
    family = False
    alliance = True
    ...
    for area_code in area_code_json:
        ...
        if apartment is not None and apartment is True:
            ...
            filtered_apartment_json = filtering_json_data(filename, apartment_json)
        ...
        if officetels is not None and officetels is True:
            ...
            filtered_officetels_json = filtering_json_data(filename, officetels_json)
        ...
        if family is not None and family is True:
            ...
            filtered_family_json = filtering_json_data(filename, family_json)
        ...
        if alliance is not None and alliance is True:
            ...
            filtered_alliance_json = filtering_json_data(filename, alliance_json)
...
def filtering_json_data(filename, json_data_list):
    building_list = []
    building_type = ""
